...
$$\matrix{\pmatrix{\text{1. Many, many sellers (and buyers)} \\ \text{2. Homogeneous product} \\ \text{3. Perfect information}} \\ \text{4. Free entry/exit} \\ \text{  }} \implies \matrix{\pmatrix{\text{Firms are} \\ \text{price} \\ \text{takers}} \\ \text{Profits/losses} \\ \text{are temporary}}$$

### General Form 

$$\pi(Q) = TR(Q) - C(Q)$$
Since price is given (by the market), $TR = PQ$:
$$\pi(Q) = PQ - C(Q)$$

...
1.  For a consumer with the same preferences (Cobb-Douglass with
    ...
    from \$100 to \$101 (`dm = 1`). Print the (already-stored) initial
...
$$\nabla x_1(m, p_1) = \begin{pmatrix} \frac{d}{dm}x_1(m, p_1) \\ \frac{d}{dp_1}x_1(m, p_1) \\ \frac{d}{dp_2}x_1(m, p_1) \end{pmatrix} 

...
If we want to try to "eyeball" the minimum of our quadratic function, we can zoom in on the range $0 \le x \le 0.5$. Run the following code to graph this portion of the domain of our function.

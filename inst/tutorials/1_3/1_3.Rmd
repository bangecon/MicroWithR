...
```{r, out.width = '300px'}
knitr::include_graphics("1_3_files/JeremyBentham.jpg")
```

### Ordinal Utility: Vilfredo Pareto (1906)

```{r, out.width = '300px'}
knitr::include_graphics("1_3_files/VilfredoPareto.jpg")
```
...
```{r}
knitr::include_graphics("1_3_files/JeremyBenthamMummy.jpg")
```
...
```{r}
knitr::include_graphics("1_3_files/JeremyBenthamHead.jpg")
```
...
```{r, out.width='300px'}
knitr::include_graphics("1_3_files/NonAlcoholicBeer.jpg")
```
...
```{r, out.width='300px'}
knitr::include_graphics("1_3_files/Pants.jpg")
```

...
```{r}
knitr::include_graphics("JeremyBenthamMummy.jpg")
```
...
```{r}
knitr::include_graphics("JeremyBenthamHead.jpg")
```
...
```{r, out.width='300px'}
knitr::include_graphics("NonAlcoholicBeer.jpg")
```
...
```{r, out.width='300px'}
knitr::include_graphics("Pants.jpg")
```
